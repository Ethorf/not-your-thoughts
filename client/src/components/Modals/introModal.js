			...
			>
				...
				<div className="intro-modal__main-container">
					<h2 className="intro-modal__description">
						Congratulations on taking the first step towards establishing a journalling practice! You can
						begin noting thoughts on this main page and watch them fancy-pancy progress-pillars fill up as
						you progress towards your daily goal. Saved entries and other settings like adjusting your daily
						goal or turning off progress sounds can be accessed via the 'Profile' page. Any questions can be
						submitted via the 'About' page. Let the noting begin!
					</h2>
