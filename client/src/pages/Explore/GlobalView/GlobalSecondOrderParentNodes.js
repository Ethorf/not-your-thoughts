...
export const positionSecondOrderParents = (anchorNode, parentNodes, depth = 1) => {
...
const GlobalSecondOrderParentNodes = ({
  anchorNode,
  nodes,
  positionedNodes,
  nodeTextures,
  ...
  const computedNodes = useMemo(() => {
    ...
    return positionSecondOrderParents(anchorNode, nodes, depth)
...
export default GlobalSecondOrderParentNodes
